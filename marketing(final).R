...
total_fb_post <- nrow(post_data_82016_122016)+nrow(post_data_12017_42017)+
                nrow(post_data_52017_82017)+nrow(post_data_92017_122017)+
                nrow(post_data_12018_42018)
total_twitter_post <- nrow(twitter)
total_sm_stat <- data.frame(matrix(nrow=2, ncol=3))
rownames(total_sm_stat) <- c("Facebook", "Twitter")
colnames(total_sm_stat) <- c("Number of posts", "Number of imppressions", "Number of engagements")
total_sm_stat[1,1]<-total_fb_post
total_sm_stat[2,1]<-total_twitter_post
total_sm_stat[1,2]<-fb_total_post_impressions
total_sm_stat[2,2]<-twitter_total_impressions
total_sm_stat[1,3]<-fb_total_post_engagement
total_sm_stat[2,3]<-twitter_total_engagements
write.csv(total_sm_stat, file="total_sm_stat.csv")